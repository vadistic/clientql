...
import { FragmentType, getCoreProps, buildOperationDoc } from '../src'
...
describe('build operation on prisma props', () => {
  it('prisma > non nested single query', () => {
    ...
    expect(print(op)).toMatchFile(...fileSnapPath('prisma.single.graphql', 'operation'))
  })
  ...
  it('prisma > non nested multi query', () => {
    ...
    expect(print(op)).toMatchFile(...fileSnapPath('prisma.multi.graphql', 'operation'))
  })
  ...
  it('prisma > nested query', () => {
    ...
    expect(print(op)).toMatchFile(...fileSnapPath('prisma.nested.graphql', 'operation'))
  })
})
...
describe('build operation on complex props', () => {
  it('complex > interface target', () => {
    ...
    expect(print(op)).toMatchFile(...fileSnapPath('complex.interface-target.graphql', 'operation'))
  })
  ...
  it('complex > inline target', () => {
    ...
    expect(print(op)).toMatchFile(...fileSnapPath('complex.inline-target.graphql', 'operation'))
  })
  ...
  it('complex > deep fragments', () => {
    ...
    expect(print(op)).toMatchFile(...fileSnapPath('complex.deep-fragments.graphql', 'operation'))
  })
