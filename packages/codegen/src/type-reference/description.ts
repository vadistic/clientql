...
export const isDescribableNode = (node: ASTNode): node is DescribableNode => 'description' in node

/**
 * prints StringValue of description props as JSDoc comment
 */
export const printDescription = (node: DescribableNode): TypescriptString | undefined =>
