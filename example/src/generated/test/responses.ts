...
export type ApplicationConnectionResponse = ApplicationConnectionFlat & {
...
export type CandidateConnectionResponse = CandidateConnectionFlat & {
  pageInfo: PageInfoFlat
...
export type JobConnectionResponse = JobConnectionFlat & {
  pageInfo: PageInfoFlat
  edges: JobEdgeFlat & {
    node: JobFlat & {
      workspace: WorkspaceFlat
...
export type SourceConnectionResponse = SourceConnectionFlat & {
  pageInfo: PageInfoFlat
...
export type TagConnectionResponse = TagConnectionFlat & {
  pageInfo: PageInfoFlat
  edges: TagEdgeFlat & {
    node: TagFlat
  }
...
export type TaskConnectionResponse = TaskConnectionFlat & {
  pageInfo: PageInfoFlat
  edges: TaskEdgeFlat & {
    node: TaskFlat & {
      owners?: UserFlat
...
export type WorkflowConnectionResponse = WorkflowConnectionFlat & {
  pageInfo: PageInfoFlat
...
export type ApplicationConnectionFlat = 
...
export type CandidateConnectionFlat = 
...
export type SourceConnectionFlat = 
...
export type TaskConnectionFlat = 
...
export type WorkflowConnectionFlat = 
